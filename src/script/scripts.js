function gerarAleatorio() {
  const phrases = [
    ...
    "Conheça seus pontos fortes - Autor: Gustavo Nascimento",
    "Aprenda a gostar e a cuidar de você - Autor: Gustavo Nascimento",
    "Fale oi para pessoas na rua, bom dia, boa tarde - Autor: Danielle Mathias",
